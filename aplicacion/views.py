...
def intro(request):
    ...
    return render(request,'introAlumni.html' )
...
def admin_capacitaciones (request):
    if request.user.is_staff:
        ...
        return render(request, 'admin_capacitaciones.html',contexto)
    else:
...
def admin_emprendimientos (request):
    if request.user.is_staff:
        ...
        return render(request, 'admin_emprendimientos.html',contexto)
    else:
        return redirect('index')
...
def admin_empleos (request):
    if request.user.is_staff:
        ...
        return render(request, 'admin_empleos.html',contexto) 
    else:
        return redirect('index')
...
def admin_administradores (request):
    if request.user.is_staff:
        ...
        return render(request, 'admin_administradores.html',contexto) 
    else:
        return redirect('index')
...
def admin_graduadospre (request):
    if request.user.is_staff:
        ...
        return render(request, 'admin_graduadospre.html',contexto)
    else:
        return redirect('index')
    ...
    if request.method == 'POST' and 'login_admin' in request.POST:
        if login_form.is_valid():
            ...
            if user is not None:
                ...
                return render(request, 'login.html', {'login_form': login_form, 'alert_message': alert_message})
        else:
    ...
    if request.user.is_staff:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'reg_administrador.html', {'form': form, 'script': script})
        else:
        ...
        return render(request, 'reg_administrador.html', context)
    else:
        return redirect('index')
...
def editar_administrador (request, id):
    if request.user.is_staff:
        ...
        if request.method == 'POST':
            form = AdministradorCreationForm(request.POST,request.FILES, instance=administrador.base)
            if form.is_valid():
                form.edit()
                return redirect('adminAdministradores')
            else:
            ...
            form = AdministradorCreationForm(instance=administrador.base)
...
def eliminar_administrador (request, id):
    if request.user.is_staff:
        ...
        return render(request, 'eliminar_administrador.html', {'admin': admin})  
    else:
        return redirect('index')
...
def previus_formulario(request):
    ...
    return render(request,'previus_form_graduado.html' )
...
def perfil_graduado(request):
    ...
    if user.is_staff:
        ...
        return render(request, 'perfilusuario.html', contexto)
    else:
        pregraduado = get_object_or_404(GraduadoPre, base=user)
        contexto = {
            'user': user, 
    ...
    if request.user.is_staff:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'reg_pregraduado.html', {'form': form, 'script': script})
        else:
            form = GraduadoPreForm()

        return render(request, 'reg_pregraduado.html', {'form': form})   
    else:
        return redirect('index')
...
def registro_graduado(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'reg_graduado_formulario.html', {'form':form, 'script': script})  
              
    return render(request, 'reg_graduado_formulario.html', {'form':form,'graduado_pre':graduado_pre})
    ...
    if request.user.is_staff:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'reg_carrera.html', {'form':form, 'script': script})  
        else:
            form = CarreraGraduadoForm()      
        return render(request, 'reg_carrera.html', {'form':form}) 
    else:
        return redirect('index')
...
def editar_carrera(request, id):
    if request.user.is_staff:
        ...
        return render(request, 'reg_carrera.html', contexto)
    else:
        return redirect('index')
...
def eliminar_carrera(request, id):
    if request.user.is_staff:
        ...
        return render(request, 'eliminar_carrera.html', {'carrera': carrera})
    else:
        return redirect('index')
...
def editar_pregraduado(request, id):
    if request.user.is_staff:
        graduado_pre = get_object_or_404(GraduadoPre, id=id)
        form = GraduadoPreForm(request.POST or None, instance=graduado_pre.base)
        ...
        if request.method == 'POST':
            if form.is_valid():
                ...
                return render(request, 'reg_carrera.html', {'form':form, 'script': script})
        return render(request, 'reg_pregraduado.html', {'form': form, 'graduado_pre': graduado_pre})
    else:
        return redirect('index')
...
def eliminar_pregraduado (request, id):
    if request.user.is_staff:
        ...
        # En el caso de 'GET', renderiza la plantilla con los detalles del graduado
        return render(request, 'eliminar_pregraduado.html', {'graduado': graduado})
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                # Usa SweetAlert2 para mostrar la notificación
                script = f"Swal.fire({{ icon: 'error', title: 'Error en el formulario', html: '{error_message}' }});"
                return render(request, 'reg_emprendimiento.html', {'form':form, 'script': script})
        else:
            data = { 'form': EmprendimientoForm(files=request.FILES)}    
        return render(request, 'reg_emprendimiento.html', data)  
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        ...
        if request.method == 'GET':
            ...
            if form.is_valid():
                form.save()
            return redirect('adminEmprendimientos')
        return render(request,'reg_emprendimiento.html', {'form':form})
    else:
        return redirect('index')
...
def eliminar_emprendimiento (request,id):
    if request.user.is_staff:
        ...
        if request.method == 'POST':
            ...
            return redirect('adminEmprendimientos')
        return render(request,'eliminar_emprendimiento.html', {'emprendimiento':emprendimiento})
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                # Usa SweetAlert2 para mostrar la notificación
                script = f"Swal.fire({{ icon: 'error', title: 'Error en el formulario', html: '{error_message}' }});"
                return render(request, 'reg_empleo.html', {'form':form, 'script': script})
        else:
            data = { 'form': EmpleoForm(files=request.FILES)}        
        return render(request, 'reg_empleo.html', data )  
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        ...
        if request.method == 'GET':
            ...
            if form.is_valid():
                form.save()
            return redirect('adminEmpleos')
        return render(request,'reg_empleo.html', {'form':form})
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                # Usa SweetAlert2 para mostrar la notificación
                script = f"Swal.fire({{ icon: 'error', title: 'Error en el formulario', html: '{error_message}' }});"
                return render(request, 'reg_capacitacion.html', {'form':form, 'script': script})
        else:
            data = { 'form': CapacitacionForm(files=request.FILES)}     
        return render(request, 'reg_capacitacion.html', data)
    else:
        return redirect('index')
    ...
    if request.user.is_staff:
        ...
        if request.method == 'GET':
            ...
            if form.is_valid():
                form.save()
            return redirect('adminCapacitaciones')
        return render(request,'reg_capacitacion.html', {'form':form})
    else:
        return redirect('index')
